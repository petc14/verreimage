...
<div class="container">
    ...
    <section class="feature-section">
        ...
        <div class="feature-image">
            <img src="<?php echo BASE_URL; ?>IMAGES/plaque-layers.png" alt="Schéma des différentes couches d'une plaque en verre Verre & Image">
        </div>
    </section>
    ...
    <section class="feature-section">
        ...
        <div class="feature-image">
            <img src="<?php echo BASE_URL; ?>IMAGES/verre-securite.jpg" alt="Gros plan sur la tranche d'un verre de sécurité épais">
        </div>
    </section>
    ...
    <section class="feature-section">
        <div class="feature-content">
            ...
            <a href="<?php echo BASE_URL; ?>contact.php" class="btn btn-secondary" style="margin-top: 20px;">Visiter notre atelier</a>
        </div>
        <div class="feature-image">
            <img src="<?php echo BASE_URL; ?>IMAGES/artisan-workshop.jpg" alt="Artisan français travaillant sur une plaque personnalisée">
        </div>
    </section>
...
<section class="cta-section">
    ...
    <a href="<?php echo BASE_URL; ?>configurateur.php" class="btn btn-primary" style="margin-top: 20px;">Commencer la personnalisation</a>
</section>
