...
if (isset($_GET['remove']) && !empty($_GET['remove'])) {
    $item_id_to_remove = (int)$_GET['remove'];
    remove_from_cart($item_id_to_remove);
    // Rediriger pour nettoyer l'URL et éviter les suppressions multiples au rafraîchissement
...
<div class="container">
    <?php if ($cart_count === 0): ?>
        <div class="empty-cart-message">
            ...
            <a href="<?php echo BASE_URL; ?>boutique.php" class="btn btn-primary" style="margin-top: 20px;">Découvrir nos modèles</a>
        </div>
    <?php else: ?>
        <div class="cart-layout">
            <!-- Panneau de gauche : Articles du panier -->
            <div class="cart-items-panel">
                <?php foreach ($cart_items as $item): ?>
                    <div class="cart-item">
                        <div class="cart-item-image">
                            <!-- Idéalement, une miniature de la personnalisation serait générée ici -->
                            <img src="<?php echo $item['details']['thumbnail'] ?? BASE_URL . 'IMAGES/placeholder-plaque.jpg'; ?>" alt="Aperçu de la plaque personnalisée">
                        </div>
                        ...
                        <div class="cart-item-actions">
                            ...
                            <a href="?remove=<?php echo $item['id']; ?>" class="remove-btn">Supprimer</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>

            <!-- Panneau de droite : Récapitulatif et validation -->
            <aside class="cart-summary-panel">
                ...
                <a href="<?php echo BASE_URL; ?>commande.php" class="btn btn-primary" style="width: 100%; margin-top: 20px;">
                    Valider ma commande
                </a>
            </aside>
        </div>
